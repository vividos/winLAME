/*
   ...
   $Id: wlOggVorbisSettingsPage.h,v 1.15 2011/01/21 17:50:26 vividos Exp $

*/
/*! \file wlOggVorbisSettingsPage.h
...
class wlOggVorbisSettingsPage:
   public wlPageBase,
   public CDialogResize<wlOggVorbisSettingsPage>
{
public:
   //! ctor
   wlOggVorbisSettingsPage()
   {
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlOggVorbisSettingsPage)
...
END_DLGRESIZE_MAP()
   ...
   // message map
BEGIN_MSG_MAP(wlOggVorbisSettingsPage)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlOggVorbisSettingsPage>)
...
protected:
   wlFixedValueSpinButtonCtrl bitrateNominalSpin;  //!< nominal bitrate spin button control
   wlFixedValueSpinButtonCtrl bitrateMinSpin;      //!< min bitrate spin button control
   wlFixedValueSpinButtonCtrl bitrateMaxSpin;      //!< max bitrate spin button control
