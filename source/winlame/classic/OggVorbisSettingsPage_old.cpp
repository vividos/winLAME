...
//
/// \file OggVorbisSettingsPage_old.cpp
...
LRESULT OggVorbisSettingsPage::OnInitDialog_(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT OggVorbisSettingsPage::OnChangeEditNominalBitrate(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
