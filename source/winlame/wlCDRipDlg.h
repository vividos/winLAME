/*
   ...
   $Id: wlCDRipDlg.h,v 1.14 2009/11/02 19:54:26 vividos Exp $
...
class wlCDRipFreedbListDlg:
   public CDialogImpl<wlCDRipFreedbListDlg>,
   public CWinDataExchange<wlCDRipFreedbListDlg>
{
public:
   /// ctor
   wlCDRipFreedbListDlg()
      :m_uSelectedItem(0){}

   /// dialog id
   enum { IDD = IDD_FREEDB_LIST };

   BEGIN_MSG_MAP(wlCDRipFreedbListDlg)
...
protected:
   ...
   wlAlternateColorsListCtrl m_list;
};


//! cd rip dialog
class wlCDRipDlg:
   public CDialogImpl<wlCDRipDlg>,
   public CWinDataExchange<wlCDRipDlg>,
   public CDialogResize<wlCDRipDlg>
{
public:
   //! ctor
   wlCDRipDlg(wlUISettings& uiSettings, wlUIinterface& UIinterface);
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlCDRipDlg)
...
BEGIN_MSG_MAP(wlCDRipDlg)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlCDRipDlg>)
   REFLECT_NOTIFICATIONS()
END_MSG_MAP()

   // dialog data exchange map
BEGIN_DDX_MAP(wlCDRipDlg)
...
protected:
   ...
   wlTrackEditListCtrl m_lcTracks;
