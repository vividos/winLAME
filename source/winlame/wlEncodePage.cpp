/*
   ...
   $Id: wlEncodePage.cpp,v 1.59 2011/01/25 19:32:38 vividos Exp $

*/
/*! \file wlEncodePage.cpp
...
// needed includes
#include "stdafx.h"
#include "wlEncodePage.h"
#include "wlErrorDlg.h"
...
// wlEncodePage methods

LRESULT wlEncodePage::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT wlEncodePage::OnClickedStart(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
...
LRESULT wlEncodePage::OnClickedStop(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
   // stop timer
...
LRESULT wlEncodePage::OnClickedToTray(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
...
LRESULT wlEncodePage::OnSystrayActive(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
   HWND parent = GetParent();
   switch((UINT)lParam)
   {
...
wlEncoderErrorHandler::wlErrorAction wlEncodePage::handleError(LPCTSTR infilename,
   LPCTSTR modulename, int errnum, LPCTSTR errormsg, bool bSkipDisabled)
{
   ...
   wlEncoderErrorHandler::wlErrorAction ret = wlEncoderErrorHandler::wlContinue;
   switch(dlg.DoModal())
   {
   case IDC_ERR_BUTTON_CONTINUE:
      ret = wlEncoderErrorHandler::wlContinue;
      break;

   case IDC_ERR_BUTTON_SKIPFILE:
      ret = wlEncoderErrorHandler::wlSkipFile;
      break;

   case IDC_ERR_BUTTON_STOP:
      ret = wlEncoderErrorHandler::wlStopEncode;
      break;
   }
   return ret;
}

void wlEncodePage::OnEnterPage()
{
 ...
 */
void wlEncodePage::ShutdownWindows(int action)
{
...
void wlEncodePage::UpdateThreadPrio()
{
   // get new pos
