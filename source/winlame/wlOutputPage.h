/*
   ...
   $Id: wlOutputPage.h,v 1.19 2011/01/21 17:50:26 vividos Exp $
...
class wlOutputPage:
   public wlPageBase,
   public CDialogResize<wlOutputPage>
{
public:
   //! ctor
   wlOutputPage()
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlOutputPage)
...
BEGIN_MSG_MAP(wlOutputPage)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlOutputPage>)
END_MSG_MAP()
// Handler prototypes:
