/*
   ...
   $Id: wlPresetManagerInterface.h,v 1.10 2004/01/14 21:32:20 vividos Exp $

*/
/*! \file wlPresetManagerInterface.h

   \brief wlPresetManagerInterface is an interface for the preset management
...
//! encoder interface
class wlPresetManagerInterface
{
public:
   //! returns a new preset manager object; use delete operator to delete it
   static wlPresetManagerInterface *getPresetManager();
   ...
   virtual void setSettings(int index, wlSettingsManager &settings_mgr)=0;

   //! sets the default settings for all variables
   virtual void setDefaultSettings(wlSettingsManager &settings_mgr)=0;

   //! shows the edit settings dialog for a specific preset
   virtual void editSettingsDialog(int index)=0;

   //! dtor
   virtual ~wlPresetManagerInterface(){}
protected:
   //! ctor
   wlPresetManagerInterface(){}
};
