...
WL_VARMAP_START(varMapFacility)
   ...
   WL_VARMAP_ENTRY1(FacilitySndFile,  _T("sndFile"),  _T("LibSndFile"))
...
WL_VARMAP_START(varMapFacilityToModule)
   ...
   WL_VARMAP_ENTRY1(ID_OM_WAVE,        _T("sndFile"),  _T("LibSndFile"))
...
WL_VARMAP_START(varMapVariables)
   ...
   WL_VARMAP_ENTRY(OggBitrateMode,   _T("vorbisBitrateMode"),    _T("Bitrate Mode"),   0)
   WL_VARMAP_ENTRY(OggBaseQuality,   _T("vorbisBaseQuality"),    _T("Base Quality"),   400)
   WL_VARMAP_ENTRY(OggVarMinBitrate, _T("vorbisVarMinBitrate"),  _T("min. Bitrate"),   64)
   WL_VARMAP_ENTRY(OggVarMaxBitrate, _T("vorbisVarMaxBitrate"),  _T("max. Bitrate"),   256)
   WL_VARMAP_ENTRY(OggVarNominalBitrate,   _T("vorbisVarNominal"),  _T("nominal Bitrate"),128)
