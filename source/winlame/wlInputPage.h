/*
   ...
   $Id: wlInputPage.h,v 1.29 2011/01/21 17:50:26 vividos Exp $
...
class wlInputConfigDlg: public CDialogImpl<wlInputConfigDlg>
{
public:
   //! ctor
   wlInputConfigDlg(){}
   ...
   void Init(wlModuleManager* mgr, std::vector<int> indices);

   //! dialog id
   enum { IDD = IDD_INMODULE_CFG };

   // message map
BEGIN_MSG_MAP(wlInputPage)
...
class wlInputPage:
   public wlPageBase,
   public CDialogResize<wlInputPage>
{
public:
   //! ctor
   wlInputPage()
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlInputPage)
...
BEGIN_MSG_MAP(wlInputPage)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlInputPage>)
   REFLECT_NOTIFICATIONS()
END_MSG_MAP()
// Handler prototypes:
