/*
   ...
   $Id: wlInputListCtrl.h,v 1.9 2007/02/23 17:27:49 vividos Exp $

*/
/*! \file wlInputListCtrl.h
...
class wlInputListCtrl: public CWindowImpl<wlInputListCtrl, CListViewCtrl>
{
public:
   //! ctor
   wlInputListCtrl();
