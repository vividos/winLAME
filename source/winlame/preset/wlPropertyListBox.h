/*
   ...
   $Id: wlPropertyListBox.h,v 1.9 2004/01/14 21:32:20 vividos Exp $

*/
/*! \file wlPropertyListBox.h
...
class wlPropertyManagerInterface
{
public:
   //! ctor
   wlPropertyManagerInterface(){};
...
class wlPropertyListBox: public CWindowImpl<wlPropertyListBox, CListBox>
{
public:
   //! ctor
   wlPropertyListBox(){ inplaceCtrl = NULL; readonly=true; }

   //! sets the property manager
   void SetPropertyManager(wlPropertyManagerInterface *mgr){ propmanager = mgr; }
...
protected:
   // message map
BEGIN_MSG_MAP(wlPropertyListBox)
...
protected:
   //! property manager
   wlPropertyManagerInterface *propmanager;
