/*
   ...
   $Id: wlPropertyListBox.cpp,v 1.11 2009/11/02 20:30:50 vividos Exp $

*/
/*! \file wlPropertyListBox.cpp
...
// wlPropertyListBox methods

void wlPropertyListBox::InitListBox(bool read_only)
{
...
LRESULT wlPropertyListBox::OnReflectedCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT wlPropertyListBox::OnDrawItem(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
void wlPropertyListBox::DrawGridLine(HDC hDC, RECT &rcGrid, UINT nPropWidth)
{
   POINT pt;
...
void wlPropertyListBox::DrawPropText(HDC hDC, LPCTSTR name, RECT &rcName,
...
void wlPropertyListBox::DrawCross(HDC hDC, RECT &rc, UINT nSize, bool bPlus)
{
...
void wlPropertyListBox::ChangeGroupState(int nIndex)
{
   if (nIndex == LB_ERR)
      return;
