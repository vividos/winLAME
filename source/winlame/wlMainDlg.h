/*
   ...
   $Id: wlMainDlg.h,v 1.38 2011/01/21 17:50:26 vividos Exp $
...
#ifndef __wlmaindlg_h_
#define __wlmaindlg_h_

// needed includes
#include "resource.h"
#include "wlPageBase.h"
#include "wlHtmlHelp.h"
...
class wlMainDlg:
   public CDialogImpl<wlMainDlg>,
   public wlUIinterface,
   public CDialogResize<wlMainDlg>
{
public:
   //! ctor
   wlMainDlg();
...
BEGIN_MSG_MAP(wlMainDlg)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlMainDlg>)
END_MSG_MAP()
// Handler prototypes:
...
//  LRESULT NotifyHandler(int idCtrl, LPNMHDR pnmh, BOOL& bHandled);
   ...
   LRESULT OnSendToPage(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
   {
      ...
      wlPageBase *pageWnd = pages[currentpage];
   ...
   // virtual interface methods from wlUIinterface
   ...
   virtual void insertWizardPage(int at, wlPageBase *page)
   {
   ...
   virtual CLanguageResourceManager& GetLanguageResourceManager()
   {
