/*
   ...
   $Id: wlCDRipPage.h,v 1.6 2011/01/21 17:50:26 vividos Exp $
...
class wlCDRipPage:
   public wlPageBase,
   public CDialogResize<wlCDRipPage>
{
public:
   /// ctor
   wlCDRipPage();
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlCDRipPage)
...
BEGIN_MSG_MAP(wlCDRipPage)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlCDRipPage>)
...
protected:
   ...
   bool ExtractTrack(wlCDRipDiscInfo& discinfo, wlCDRipTrackInfo& trackinfo, const CString& cszTempFilename);
...
protected:
   ...
   /// tracks list
   wlAlternateColorsListCtrl m_lcTracks;
