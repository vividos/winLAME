...
namespace UI
{
   ...
   public:
      ...
      static void SetWizardPageByOutputModule(WizardPageHost& pageHost, int outputModuleId);
   ...
   private:
      ...
      BEGIN_DDX_MAP(OutputSettingsPage)
         ...
         DDX_CONTROL_HANDLE(IDC_OUT_COMBO_OUTMODULE, m_comboOutputModule)
         DDX_CONTROL_HANDLE(IDC_OUT_USE_INDIR, m_checkUseInputDir)
         DDX_CONTROL_HANDLE(IDC_OUT_OUTPATH, m_comboOutputPath)
         ...
         DDX_CONTROL_HANDLE(IDC_OUT_PLAYLISTNAME, m_editPlaylistName)
         DDX_CONTROL_HANDLE(IDC_OUT_SELECTPATH, m_buttonSelectPath)
      END_DDX_MAP()
   ...
   private:
      ...
      CComboBox m_comboOutputModule;

      CComboBox m_comboOutputPath;  ///< output path combobox
      ...
      CEdit m_editPlaylistName;     ///< playlist filename
      CButton m_buttonSelectPath;   ///< "select path" button
