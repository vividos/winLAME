...
namespace UI
{
   ...
   class ImageListComboBox :
      public CWindowImpl<ImageListComboBox, CComboBox>,
      public COwnerDraw<ImageListComboBox>
   {
   public:
      ImageListComboBox()
         :m_uiItemWidth(0),
   ...
   private:
      ...
      BEGIN_MSG_MAP_EX(ImageListComboBox)
