...
private:
   ...
   BEGIN_DDX_MAP(LAMESettingsPage)
      ...
      DDX_CONTROL_HANDLE(IDC_LAME_COMBO_ENCODING_QUALITY, m_cbEncodingQuality)
      DDX_CONTROL_HANDLE(IDC_LAME_COMBO_VBR_MODE, m_cbVariableBitrateMode)
      ...
      DDX_RADIO(IDC_LAME_RADIO_TYPE1, m_iRadioType);
   END_DDX_MAP()
