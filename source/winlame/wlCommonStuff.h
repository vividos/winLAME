...
class wlBevelLine: public CWindowImpl<wlBevelLine>
{
public:
BEGIN_MSG_MAP(wlBevelLine)
...
class wlFixedValueSpinButtonCtrl: public CWindowImpl<wlFixedValueSpinButtonCtrl>
{
public:
   //! ctor
   wlFixedValueSpinButtonCtrl(){ values = NULL; arrsize = 0; }
   //! dtor
   virtual ~wlFixedValueSpinButtonCtrl(){ delete values; }

   // message map
BEGIN_MSG_MAP(wlFixedValueSpinButtonCtrl)
...
class wlAlternateColorsListCtrl:
   public CWindowImpl<wlAlternateColorsListCtrl, CListViewCtrl>,
   public CCustomDraw<wlAlternateColorsListCtrl>
{
public:
protected:
   // message map
BEGIN_MSG_MAP(wlAlternateColorsListCtrl)
   CHAIN_MSG_MAP_ALT(CCustomDraw<wlAlternateColorsListCtrl>, 1)
END_MSG_MAP()
