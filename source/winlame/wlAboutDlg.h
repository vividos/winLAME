/*
   ...
   $Id: wlAboutDlg.h,v 1.14 2010/01/08 18:05:50 vividos Exp $
...
class wlAboutDlg: public CAxDialogImpl<wlAboutDlg>
{
public:
   //! ctor
   wlAboutDlg(){ min_cx = min_cy = last_cx = last_cy = -1; }

   //! dialog id
   enum { IDD = IDD_ABOUTDLG };

   //! sets module manager to use
   void SetModuleManager(wlModuleManager *mgr){ module_manager = mgr; };
