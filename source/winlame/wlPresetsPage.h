/*
   ...
   $Id: wlPresetsPage.h,v 1.12 2011/01/21 17:50:26 vividos Exp $

*/
/*! \file wlPresetsPage.h
...
class wlPresetsPage:
   public wlPageBase,
   public CDialogResize<wlPresetsPage>
{
public:
   //! ctor
   wlPresetsPage()
   ...
   // resize map
BEGIN_DLGRESIZE_MAP(wlPresetsPage)
...
BEGIN_MSG_MAP(wlPresetsPage)
   ...
   CHAIN_MSG_MAP(CDialogResize<wlPresetsPage>)
END_MSG_MAP()
// Handler prototypes:
