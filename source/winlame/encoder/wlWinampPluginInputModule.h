/*
   ...
   $Id: wlWinampPluginInputModule.h,v 1.16 2007/02/23 17:26:37 vividos Exp $

*/
/*! \file wlWinampPluginInputModule.h
...
class wlWinampPluginInputModule: public wlInputModule
{
public:
   // ctor
   wlWinampPluginInputModule();
   //! dtor
   virtual ~wlWinampPluginInputModule();
