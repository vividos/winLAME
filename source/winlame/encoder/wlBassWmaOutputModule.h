/*
   ...
   $Id: wlBassWmaOutputModule.h,v 1.5 2010/01/08 19:58:43 vividos Exp $

*/
/*! \file wlBassWmaOutputModule.h
...
class wlBassWmaOutputModule: public wlOutputModule
{
public:
   // ctor
   wlBassWmaOutputModule();
   ...
   void prepareOutput(wlSettingsManager &mgr);
