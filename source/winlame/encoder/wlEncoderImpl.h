/*
   ...
   $Id: wlEncoderImpl.h,v 1.30 2011/01/25 19:32:38 vividos Exp $

*/
/*! \file wlEncoderImpl.h
...
class wlEncoderImpl: public wlEncoderInterface
{
public:
   //! ctor
   wlEncoderImpl()
   ...
   virtual void setSettingsManager(wlSettingsManager *mgr)
   {
      settings_mgr = mgr;
   }

   //! sets the module manager to use
   virtual void setModuleManager(wlModuleManager *mgr)
   {
      mod_manager = mgr;
   }
   ...
   virtual void setErrorHandler(wlEncoderErrorHandler *thehandler)
   {
      handler = thehandler;
   }
...
protected:
   ...
   {
      wlEncoderImpl* enc = reinterpret_cast<wlEncoderImpl*>(ptr);
      enc->encode();
      _endthread();
   }
...
protected:
   ...
   wlSettingsManager *settings_mgr;

   //! module manager
   wlModuleManager *mod_manager;

   //! error handler interface
   wlEncoderErrorHandler *handler;
