/*
   ...
   $Id: wlFlacInputModule.h,v 1.6 2009/11/02 20:30:52 vividos Exp $

*/
/*! \file wlFlacInputModule.h
...
#ifndef __wlflacinputmodule_h_
#define __wlflacinputmodule_h_
...
typedef struct {
   ...
   wlTrackInfo* trackInfo;                      ///< track info
} FLAC_context;

//! FLAC input module

class wlFlacInputModule: public wlInputModule
{
public:
   // ctor
   wlFlacInputModule();
