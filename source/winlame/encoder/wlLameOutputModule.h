/*
   ...
   $Id: wlLameOutputModule.h,v 1.29 2010/01/08 19:58:43 vividos Exp $

*/
/*! \file wlLameOutputModule.h
...
class wlLameOutputModule: public wlOutputModule
{
public:
   // ctor
   wlLameOutputModule();

   virtual ~wlLameOutputModule();
...
private:
   ...
   void AddLameID3v2Tag(const wlTrackInfo& trackinfo);
