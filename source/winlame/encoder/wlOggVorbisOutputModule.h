/*
   ...
   $Id: wlOggVorbisOutputModule.h,v 1.16 2010/01/08 19:58:43 vividos Exp $

*/
/*! \file wlOggVorbisOutputModule.h
...
class wlOggVorbisOutputModule: public wlOutputModule
{
public:
   // ctor
   wlOggVorbisOutputModule();
   // dtor
   ~wlOggVorbisOutputModule();
