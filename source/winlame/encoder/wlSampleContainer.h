/*
   ...
   $Id: wlSampleContainer.h,v 1.5 2004/01/14 21:32:20 vividos Exp $

*/
/*! \file wlSampleContainer.h
...
typedef enum
{
   wlSamplesChannelArray=0,
   wlSamplesInterleaved=1
} wlSampleFormatType;
...
public:
   ...
   void setInputModuleTraits(int bits_per_sample, wlSampleFormatType format,
   ...
   void setOutputModuleTraits(int bits_per_sample, wlSampleFormatType format,
...
protected:
   //! source traits
   wlModuleTraits source;

   //! target traits
   wlModuleTraits target;
