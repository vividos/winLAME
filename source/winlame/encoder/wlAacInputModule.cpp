/*
   ...
   $Id: wlAacInputModule.cpp,v 1.28 2009/12/17 18:49:51 vividos Exp $

*/
/*! \file wlAacInputModule.cpp
...
// wlAacInputModule methods

wlAacInputModule::wlAacInputModule()
{
   module_id = ID_IM_AAC;
}

wlInputModule *wlAacInputModule::cloneModule()
{
   return new wlAacInputModule;
}

bool wlAacInputModule::isAvailable()
{
...
void wlAacInputModule::getDescription(CString& desc)
{
...
CString wlAacInputModule::getFilterString()
{
   CString cszFilter;
...
int wlAacInputModule::initInput(LPCTSTR infilename, wlSettingsManager &mgr,
...
void wlAacInputModule::getInfo(int &channels, int &bitrate, int &length, int &samplerate)
{
...
int wlAacInputModule::decodeSamples(wlSampleContainer &samples)
{
   // frame decoding info
   NeAACDecFrameInfo frameinfo;
...
void wlAacInputModule::doneInput()
{
