/*
   ...
   $Id: wlInputListCtrl.cpp,v 1.14 2009/11/02 19:54:26 vividos Exp $

*/
/*! \file wlInputListCtrl.cpp
...
// wlInputListCtrl methods

wlInputListCtrl::wlInputListCtrl()
{
   dragging=false;
   lastsortcolumn = -1;
}
...
void wlInputListCtrl::DeleteSelectedListItems()
{
...
void wlInputListCtrl::InsertFile(LPCTSTR filename, int icon, int samplerate,
...
LPCTSTR wlInputListCtrl::GetFileName(int index)
{
...
unsigned int wlInputListCtrl::GetTotalLength()
{
...
int wlInputListCtrl::SortCompare(LPARAM lParam1, LPARAM lParam2,
   LPARAM lParamSort)
{
   // get pointers
   ...
   wlInputListCtrl *This = reinterpret_cast<wlInputListCtrl*>(lParamSort);
...
LRESULT wlInputListCtrl::OnReflectedNotify(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
   ...
   case LVN_COLUMNCLICK:
      {
         ...
         // sort
         SortItems(wlInputListCtrl::SortCompare,
...
LRESULT wlInputListCtrl::OnMouseMove(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
   if (dragging)
   {
...
LRESULT wlInputListCtrl::OnLButtonUp(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
   if (dragging)
   {
      // end dragging
...
LRESULT wlInputListCtrl::OnListContextMenu(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
   // load popup menu
...
void wlInputListCtrl::MoveItem(int moveTo)
{
   if(moveTo<0)
      moveTo = GetItemCount();
