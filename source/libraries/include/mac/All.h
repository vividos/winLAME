...
#define PLUGIN_NAME								_T("Monkey's Audio Player v3.99")
#define MJ_PLUGIN_NAME							_T("APE Plugin (v3.99)")
#define CONSOLE_NAME							_T("--- Monkey's Audio Console Front End (v 3.99) (c) Matthew T. Ashland ---\n")
...
#define MBN(NUMBER) { TCHAR cNumber[16]; _stprintf(cNumber, _T("%d"), NUMBER); MESSAGEBOX(NULL, cNumber, "Message...", MB_OK); }
