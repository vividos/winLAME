...
#define MAC_FORMAT_FLAG_HAS_PEAK_LEVEL		4	// unsigned __int32 Peak_Level after the header [OBSOLETE]
...
public:
	...
	*********************************************************************************************/
	...
	virtual int Start(const wchar_t * pOutputFilename, const WAVEFORMATEX * pwfeInput, 
...
extern "C"
{
	IAPEDecompress * __stdcall CreateIAPEDecompress(const wchar_t * pFilename, int * pErrorCode = NULL);
...
{
	// process whole files
	DLLEXPORT int __stdcall CompressFile(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel = COMPRESSION_LEVEL_NORMAL, int * pPercentageDone = NULL, APE_PROGRESS_CALLBACK ProgressCallback = 0, int * pKillFlag = NULL);
	...
	DLLEXPORT int __stdcall CompressFileW(const wchar_t * pInputFilename, const wchar_t * pOutputFilename, int nCompressionLevel = COMPRESSION_LEVEL_NORMAL, int * pPercentageDone = NULL, APE_PROGRESS_CALLBACK ProgressCallback = 0, int * pKillFlag = NULL);
	DLLEXPORT int __stdcall DecompressFileW(const wchar_t * pInputFilename, const wchar_t * pOutputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag);
	DLLEXPORT int __stdcall ConvertFileW(const wchar_t * pInputFilename, const wchar_t * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag);
	DLLEXPORT int __stdcall VerifyFileW(const wchar_t * pInputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag, BOOL bQuickVerifyIfPossible = FALSE); 
