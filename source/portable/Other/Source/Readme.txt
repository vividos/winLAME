...
user in an INI file next to winLAMEPortable.exe called winLAMEPortable.ini.
...
copy AppNamePortable.ini from this directory to winLAMEPortable.ini next to
winLAMEPortable.exe. The options in the INI file are as follows:
